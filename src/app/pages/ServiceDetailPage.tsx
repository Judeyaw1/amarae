          ...
          <div className="grid lg:grid-cols-[1fr_0.9fr] gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a href="#book" className="inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-accent-foreground shadow-[0_18px_50px_rgba(161,201,231,0.35)] hover:bg-accent/90 transition-colors">
                  Book a Consultation
