        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link to="/consultation" className="bg-accent text-accent-foreground text-sm font-semibold px-5 py-2.5 rounded hover:bg-accent/90 transition-colors">
        ...
        {mobileOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white">
            <div className="px-4 py-3 space-y-1">
              ...
              <Link to="/consultation" className="block mt-2 bg-accent text-accent-foreground text-center text-sm font-semibold px-4 py-2.5 rounded hover:bg-accent/90 transition-colors">
                Book Free Consultation
              </Link>
            </div>
          </div>
